...
class ReviewPhoneNumberKeyboard extends BaseKeyboard {
  const ReviewPhoneNumberKeyboard({
    super.key,
  ...
  @override
  BaseKeyboardState createState() => _ReviewPhoneNumberKeyboardState();
}

class _ReviewPhoneNumberKeyboardState extends BaseKeyboardState {
  @override
  renderText() {
  ...
  @override
  nextPage() {
    return PageConfig().reviewPhoneNumberKeyboard(amount);
  }
}
